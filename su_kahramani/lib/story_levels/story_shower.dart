...
class StoryShower extends StatelessWidget {
  final String userName;

  const StoryShower({super.key, required this.userName});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          _storyTeller(
            "$userName sulama sonrası kirlenmiştir. Banyo yapması gerektiğini düşünür. \n\n"
            "Su kahramanı $userName nelere dikkat etmeli?",
          ),
